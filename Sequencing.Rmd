...
Our sequencing and assembly strategy is described in section \@ref(wetlab), but a summary of sequence data and their associated NGS platforms is provided below (see also Table \@ref(tab:tabproject) for biomass requierment and Table \@ref(tab:dataseq) for sequecning data per technology):
...
- **Proximity ligation**: 
    - [Omni-C libraries](https://dovetailgenomics.com/intro-omni-c-tech/) (sequenced on an Illumina platform): 3 runs (each 2x150bp yielding 100M raw paired-end reads). These data will be used to conduct phasing of the genome.
- **RNASeq**: 
