...
dat <- data.frame(Type = c("Illumina NovaSeq","PacBio sequencing", "Proximity ligation (Hi-C for phasing genome)", "RNA-seq"),
                    #Add purpose
                    Purpose = c("Genome size and complexity","De novo genome assembly", "Phasing", "Annotation"),
                    # add requirements 
