...
# Managing accounts and sharing folder on Linux computers

To more efficiently benefit from our Linux computer, we will provide overview of protocols to:
...
For this purpose, we will be using the `useradd` command:

```{bash, eval=F}
#Create user, add password and create home directory
sudo useradd userID
```
